...
from gatv2 import GAT, GATv2_Model

# Training code referenced from DGL, trained with GATv2 Layer
...
def run(args, device, data):
    ...
    # )
    model = GATv2_Model(
         in_feats, args.num_hidden, n_classes, args.num_layers, num_heads, args=args
     )
